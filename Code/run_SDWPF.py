...
import os
import pandas as pd
from model.model_SDWPF import TimePFN
from long_term import Long_Term_Forecast
...
parser.add_argument('--P', type=int, default=288,
                    help='history steps')
parser.add_argument('--Q', type=int, default=144,
...
parser.add_argument('--d_ff', type=int, default=512, help='dimension of fcn[default : 2048]')
...
parser.add_argument('--model_file', default='data/SDWPF/Hiformer_march',
                    help='save the model to disk')
parser.add_argument('--best_model_file', default='data/SDWPF/Hiformer_march_all',
                    help='save the model to disk')
parser.add_argument('--data_file', default='./data/SDWPF',
                    help='data file')
