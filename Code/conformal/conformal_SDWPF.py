...
prediction_sets = [
    np.clip(prediction_sets[0], 0, 200),  # 对下界限制范围
    np.clip(prediction_sets[1], 0, 200)   # 对上界限制范围
]
...
naive_prediction_sets = [
    np.clip(naive_prediction_sets[0], 0, 200),  # 对下界限制范围
    np.clip(naive_prediction_sets[1], 0, 200)   # 对上界限制范围
]
end_naive = time.time()
