...
import os
import pandas as pd
from model.model_GEF import TimePFN
...
parser.add_argument('--d_ff', type=int, default=1024, help='dimension of fcn[default : 2048]')
...
parser.add_argument('--model_file', default='data/GEFcom/Hiformer_march',
                    help='save the model to disk')
parser.add_argument('--best_model_file', default='data/GEFcom/Hiformer_march_all',
                    help='save the model to disk')
parser.add_argument('--data_file', default='./data/GEFcom',
                    help='data file')
